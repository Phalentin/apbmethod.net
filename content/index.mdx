...
1. [2x2x3](/tutorial/223): Solve a 2x2x3 block in the bottom-left. This is usually accomplished by building a Roux-style 1x2x3 block and then extending it by solving the DF and DB edges.
2. [dBR Pair](/tutorial/pair): The back-right F2L pair is solved intuitively.
3. [EO](/tutorial/eo): The edge-orientation of the remaining edges is solved algorithmically (11 algorithms).
4. [LXS](/tutorial/lxs): The remaining three F2L pieces are solved algorithmically (116 algorithms).
5. [ZBLL](/tutorial/zbll): The last layer is solved (493 algorithms).
