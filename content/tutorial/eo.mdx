...
You might not be used to doing S-moves in the middle of your solve, but they are really not a problem. Try to think of them as just F-moves but one layer further back. Unlike F-moves however, you should be able to do push-turns as well. If you still have problems, see the small guide below:
