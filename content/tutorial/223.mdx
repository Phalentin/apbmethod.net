...
On some scrambles, solving the 2x2x3 like F2L in CFOP, except without any of the pieces in the R-layer, is the fastest method. Even though the movecount might not be too low, this method does allow for high TPS. Keep in mind we really only recommend this, if:
